                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-4 col-12">
                            ...
                            <div class="input-group input-group-sm mb-3">
                                ...
                                <form:input path="password" type="text" class="form-control" disabled="true"/>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-2 col-12">
                            <label>Telefon:</label>
                        ...
                        <div class="col-lg-2 col-sm-2 col-12">
                            ...
                            <div class="input-group input-group-sm mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fab fa-get-pocket"></i></span>
                                </div>
                                <form:input path="category" type="text" class="form-control" disabled="true"/>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-2 col-12">
...
<script type="text/javascript">
    ...
    function showSubcategory() {
        ...
        if (category === "prywatny") {
            document.getElementById("subcategory").value = "prywatny";
        } else if (category === "służbowy") {
            document.getElementById("subcategory").value = "służbowy";
        } else if (category === "inny") {
            document.getElementById("subcategory").value = "inny";
        }
    }
</script>
